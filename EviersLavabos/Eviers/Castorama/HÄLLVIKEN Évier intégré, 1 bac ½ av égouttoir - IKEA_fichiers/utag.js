...
// CHANGED TEMPLATE: hardcoded currency to EUR on line 55
// Modification made by Philip Sydhoff on 20/11/15

//tealium universal tag - utag.sender.6026 ut4.0.201612081622, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.std_params = {
      ...
      // changed TEMPLATE here
      "currency" : function(g) {
	u.data.ecom.order_currency = "EUR";
    ...
    u.calc_items = function(quan) {
      ...
      u.map={"product_prices_vat":"product_unit_price","_ccurrency":"order_currency","product_ids":"product_id","product_item_names":"product_name","cart_event:add_to_cart":"AddToCart","cart_event:add_to_list":"AddToWishlist","site_level_2":"product_category","page_type:product information page":"ViewContent","page_type:checkout > welcome":"InitiateCheckout","page_type:checkout > step4":"Purchase","page_type:search":"Search","site_level_1":"vc.content_type","facebook_user_registered:registered":"CompleteRegistration"};
  u.extend=[function(a,b){ try{ if(b['page_type'].toString().toLowerCase()=='product information page'.toLowerCase()){b['site_level_1']='product'} } catch(e){ utag.DB(e) }  }];
      ...
      for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){if(typeof utag_err!='undefined'){utag_err.push({e:'extension error:'+e,s:utag.cfg.path+'utag.'+id+'.js',l:c,t:'ex'})}}};
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_86'});
            //FB PreLoad Code
            !function (f, b, e) {
