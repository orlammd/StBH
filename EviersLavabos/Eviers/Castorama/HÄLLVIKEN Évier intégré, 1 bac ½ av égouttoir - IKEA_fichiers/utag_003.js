//tealium universal tag - utag.loader ut4.42.201704261157, Copyright 2017 Tealium.com Inc. All Rights Reserved. 

if(typeof utag_err=='undefined')var utag_err=[];window._tealium_old_error=window._tealium_old_error || window.onerror || function(){};window.onerror=function(m,u,l){if(typeof u !== 'undefined' && u.indexOf('/utag.')>0 && utag_err.length < 5)utag_err.push({e:m,s:u,l:l,t:'js'});window._tealium_old_error(m,u,l)};
var utag_condload=false;try{(function(){function ul(src,a,b){a=document;b=a.createElement('script');b.language='javascript';b.type='text/javascript';b.src=src;a.getElementsByTagName('head')[0].appendChild(b)};if((""+document.cookie).match("utag_env_ikea_fr-main=(\/\/tags\.tiqcdn\.com\/utag\/ikea\/[^\S;]*)")){if(RegExp.$1.indexOf("/prod/") === -1) {ul(RegExp.$1);utag_condload=true;__tealium_default_path='//tags.tiqcdn.com/utag/ikea/fr-main/prod/';}}})();}catch(e){};try{
/*
 * @author: kevin thomas faurholt - tealium, inc
 *
 * @extension: capture-email-and-member-id
 * 
...
(function() {
  ...
  var view = window.TEALIUM.datalayer.view;
  
  // landing page after the user login page
  // e.g. https://secure.ikea.com/webapp/wcs/stores/servlet/LogonForm?storeId=14&langId=-12&catalogId=11001
  if (/secure\.ikea\.com\/webapp\/wcs\/stores\/servlet\/MyProfile/i.test (document.URL)) {
    
    try {
      
      $$("li[class='ppSectionListLink']").each (function (item) {
        ...
        if (link) {
          ...
          if (/formName=updatePrivatePersonal|formName=updateFamilyPersonal/i.test (link.href)) {

            // get the email address, 2 li elements higher up
            var $previous = $($li.previous(1));

            var email = $previous.innerHTML.stripTags();

            email = email.replace(/(.+)&nbsp;(.+)/, "$2");

            view.member_email = email.replace(/(\r\n|\n|\r|\s)/gm, "");
          }
          else if(/formName=familyCardReq/i.test(link.href)) {

            var $previous = $($li.previous());

            var memberid = $previous.innerHTML.stripTags();

            memberid = memberid.replace(/[^0-9]+/g, "").replace(/(\r\n|\n|\r)/gm, "");

            view.member_id = memberid;
          }
        }
      });
      
      // user created new member id card. a temporary print card link is shown
      var tempid = $$("a[href='/webapp/wcs/stores/servlet/IrwPrintTemporaryFamilyCard']")[0];
      
      if (tempid) {
        
        var $previous = $(tempid).closest("li").previous();
  ...
  // logged in step 1 checkout process
  else if (/secure\.ikea\.com\/webapp\/wcs\/stores\/servlet\/IrwCheckoutAddressView/i.test (document.URL)) {
  
    try {
      // email field available
      var email = $$("input#signup_checkout_private_email1")[0];
      
      if (email) {
        
        view.member_email = email.value;
      }
      
      // member id available (not available in ikea.dk but is present in ikea.fr)
      var memberid = $$("input#signup_checkout_private_userProfileField1")[0];
      
      if (memberid) {
        
        view.member_id = memberid.value;
      }
    }
    catch(e) {}
  }
...
if(!utag_condload){try{(function() {var c=' '+document.cookie;if(c.indexOf('wasd_split_segment_cookie=')<0){var r=parseInt((Math.random()*100)+1);var s={'A':20,'B':20,'C':20,'D':20,'E':20};var g={},k=0,i;for(i in s){k++;g[i]={};g[i].min=k;k=k+s[i]-1;g[i].max=k;};for(i in g){if(r>=g[i].min&&r<=g[i].max){s=i;break;};};document.cookie="wasd_split_segment_cookie="+s+";path=/;domain=.ikea.com;expires=";}})();}catch(e){}};
...
if (typeof utag == "undefined" && !utag_condload) {
  ...
  utag.cfg = {
    ...
    path: "//tags.tiqcdn.com/utag/ikea/fr-main/prod/",
    utid: "ikea/fr-main/201704261157"
  };
  utag.cfg.v = utag.cfg.template + "201704261157";
  utag.cond={103:0,104:0,107:0,139:0,142:0,143:0,144:0,145:0,146:0,149:0,150:0,154:0,158:0,161:0,162:0,163:0,164:0,165:0,166:0,180:0,181:0,182:0,183:0};
...
case '103':try{c[103]|=(d['page_name'].toString().toLowerCase()=='home page'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='living room>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='bedroom>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='metod kitchen & appliances>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='bathroom>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='childrens ikea>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='for business>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='outdoor>front'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '104':try{c[104]|=(d['page_name'].toString().toLowerCase()=='home page'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='living room>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='bedroom>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='metod kitchen & appliances>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='bathroom>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='childrens ikea>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='for business>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='outdoor>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='checkout>shopping cart'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='secondary storage>front'.toLowerCase())||(d['page_name'].toString().toLowerCase()=='lighting>front'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '107':try{c[107]|=(typeof d['visit_country']!='undefined'&&d['visit_country']!=''&&typeof d['visit_language']!='undefined'&&d['visit_language']!=''&&d['page_path']=='/')||(d['page_type'].toString().toLowerCase()=='home page'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '139':try{c[139]|=(d['page_type'].toString().toLowerCase()=='shopping cart'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '142':try{c[142]|=(typeof d['page_type']!='undefined'&&d['page_type']!=''&&d['page_type'].toString().toLowerCase()=='checkout > welcome'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '143':try{c[143]|=(d['page_type'].toString().toLowerCase()=='checkout > step1'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '144':try{c[144]|=(d['page_type'].toString().toLowerCase()=='checkout > step2'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '145':try{c[145]|=(d['page_type'].toString().toLowerCase()=='checkout > step3'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '146':try{c[146]|=(d['page_type'].toString().toLowerCase()=='checkout > step4'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '149':try{c[149]|=(typeof d['mediamind_activityid']!='undefined'&&d['mediamind_activityid']!='')}catch(e){utag.DB(e)}; break;
case '150':try{c[150]|=(d['dom.url'].toString().indexOf('http://www.ikea.com/ms/fr_FR/this-is-ikea/people-and-planet/sustainable-life-at-home/index.html')>-1)}catch(e){utag.DB(e)}; break;
case '154':try{c[154]|=(d['previous_page_name'].toString().toLowerCase().indexOf('login>front'.toLowerCase())>-1&&d['site_level_3'].toString().toLowerCase().indexOf('my profile information'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;
case '158':try{c[158]|=(d['page_name'].toString().toLowerCase().indexOf('checkout>confirmation'.toLowerCase())<0)}catch(e){utag.DB(e)}; break;
case '161':try{c[161]|=(d['page_type'].toString().toLowerCase()=='search'.toLowerCase()&&typeof d['product_event']=='undefined'&&typeof d['cp.criteo_block_cookie']=='undefined')||(d['page_type'].toString().toLowerCase()=='search'.toLowerCase()&&typeof d['product_event']!='undefined'&&d['product_event']!=''&&d['product_event'].toString().toLowerCase()!='view'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')||(d['page_type'].toString().toLowerCase()=='category'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')||(d['page_type'].toString().toLowerCase()=='listpage'.toLowerCase()&&d['page_name'].toString().toLowerCase().indexOf('products a-z'.toLowerCase())<0&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '162':try{c[162]|=(d['page_type'].toString().toLowerCase()=='product information page'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '163':try{c[163]|=(d['cart_event'].toString().toLowerCase()=='add_to_list'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '164':try{c[164]|=(d['page_type'].toString().toLowerCase()=='shopping cart'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '165':try{c[165]|=(d['cart_event'].toString().toLowerCase()=='add_to_cart'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '166':try{c[166]|=(d['page_type'].toString().toLowerCase()=='checkout > step4'.toLowerCase()&&typeof d['cp.criteo_block_cookie']=='undefined')}catch(e){utag.DB(e)}; break;
case '180':try{c[180]|=(d['dom.pathname'].toString().toLowerCase()=='/fr/fr/store/roissy/'.toLowerCase())||(d['dom.pathname'].toString().toLowerCase()=='/fr/fr/store/toulon/'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '181':try{c[181]|=(d['page_type'].toString().toLowerCase()=='checkout > step4'.toLowerCase()&&d['dom.domain'].toString().toLowerCase().indexOf('pirw'.toLowerCase())<0&&d['dom.domain'].toString().toLowerCase().indexOf('preview'.toLowerCase())<0)}catch(e){utag.DB(e)}; break;
case '182':try{c[182]|=(d['page_path'].toString().toLowerCase()=='/store/orleans/indexpage'.toLowerCase())}catch(e){utag.DB(e)}; break;
case '183':try{c[183]|=(d['page_path'].toString().toLowerCase()=='/webapp/wcs/stores/servlet/createuser'.toLowerCase())}catch(e){utag.DB(e)}; break;}}};utag.pre=function() {    utag.loader.initdata();utag.pagevars();    try{utag.loader.RD(utag.data)}catch(e){utag.DB(e)};    utag.loader.loadrules();        };utag.loader.GET=function(){utag.cl={'_all_':1};utag.pre();
...
function(a,b,c,d,e,f,g){d=b['page_name'];if(typeof d=='undefined')return;c=[{'bedroom>front':'606560'},{'bathroom>front':'606562'},{'metod kitchen & appliances>front':'606568'},{'outdoor>front':'606570'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d==f){b['mediamind_activityid']=c[e][f];m=true};};if(m)break};if(!m)b['mediamind_activityid']='';},
function(a,b,c,d,e,f,g){d=b['cart_event'];if(typeof d=='undefined')return;c=[{'add_to_list':'addToList'},{'add_to_cart':'addToCart'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d==f){b['criteo_event']=c[e][f];m=true};};if(m)break};if(!m)b['criteo_event']='';},
function(a,b){b['previous_page_name']=b['cp.utag_main__prevpage'];utag.loader.SC('utag_main',{'_prevpage':b['page_name']+';exp-1h'})},
function(a,b){
/*
 * @author: Karl Norling, CountQuest Interactive
 *
 * @extension: site_levels in comma separated string
 *
 * @purpose:
 * set site_levels in comma separated string for tags that need entire site level path
 *
 * @extension scope: all tags
 */

if (b.site_level_1){
  b.site_levels = b.site_level_1
};
if (b.site_level_2){
  b.site_levels = b.site_levels.concat(",",b.site_level_2);
};
if (b.site_level_3){
  b.site_levels = b.site_levels.concat(",",b.site_level_3);
};
if (b.site_level_4){
  b.site_levels = b.site_levels.concat(",",b.site_level_4);
};
if (b.site_level_5){
  b.site_levels = b.site_levels.concat(",",b.site_level_5);
};
},
function(a,b){
/*
 * @author: Karl Norling, CountQuest Interactive
 *
 * @extension: number of products and total items in cart
 *
 * @purpose:
 * set total quantities of products and items for tags that need aggregate numbers instead of array of numbers
 *
 * @extension scope: all tags
 */
if(utag.data.product_units){
b.products_in_cart = utag.data.product_units.length;
b.product_items_in_cart = 0;
for(var i = 0; i < utag.data.product_units.length; i++)
{
    b.product_items_in_cart = b.product_items_in_cart + parseInt(utag.data.product_units[i]);
};
}
},
function(a,b){ try{ if(b['previous_page_name'].toString().toLowerCase()=='family>create user'.toLowerCase()||b['page_name'].toString().toLowerCase()=='crm>my profile>my profile information'.toLowerCase()){b['facebook_user_registered']='registered'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if(b['dom.query_string'].toString().indexOf('affilinet')>-1){b['qp.query']='affilinet'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if(b['qp.query'].toString().toLowerCase().indexOf('affilinet'.toLowerCase())>-1){document.cookie="criteo_block_cookie="+b['qp.query']+";path=/;domain="+utag.cfg.domain+";expires=";b['cp.criteo_block_cookie']=b['qp.query'];}} catch(e){ utag.DB(e) } },
function(a,b,c,d,e,f,g){d=b['page_type'];if(typeof d=='undefined')return;c=[{'home page':'20727418'},{'department':'20727419'},{'shopping cart':'20727421'},{'product information page':'20727420'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d==f){b['rocketfuel_conversion_ID']=c[e][f];m=true};};if(m)break};if(!m)b['rocketfuel_conversion_ID']='';},
function(a,b){ try{ if(1){b['rocketfuel_o_paramter']='25228'} } catch(e){ utag.DB(e) }  },
function(a,b){
if (utag.data['page_type'] == "checkout > step4") {

if (utag.data['cp.rocketfuel_returning_customer']=== undefined) {
  b['rocketfuel_returning_customer'] = utag.data['rocketfuel_returning_customer'] = 1;
  amigocookie("1",365);
  return
}
  else if(utag.data['cp.rocketfuel_returning_customer']==1){
	  amigocookie("2",365); 
  b['rocketfuel_returning_customer'] = utag.data['rocketfuel_returning_customer'] = 2;
     }
  
    else if(utag.data['cp.rocketfuel_returning_customer']==2){
  b['rocketfuel_returning_customer'] = utag.data['rocketfuel_returning_customer'] = 2;
     }
  
function amigocookie(cvalue, exdays) {
    var d = new Date();
    d.setTime(d.getTime() + (exdays*24*60*60*1000));
    var expires = "expires="+d.toUTCString();
    document.cookie = "rocketfuel_returning_customer=" + cvalue + ";path=/ ; " + expires; }
}
},
function(a,b){
...
if(utag.data['rocketfuel_returning_customer'] == 1){
utag.data['quantcast_returning_customer'] = b['quantcast_returning_customer']  = "_fp.customer."+"0";
}
  else if(utag.data['rocketfuel_returning_customer'] == 2){
  utag.data['quantcast_returning_customer'] = b['quantcast_returning_customer']  = "_fp.customer."+"1";
 
  }
  }
}
},
function(a,b){ try{ if(b['page_name']=='checkout>select delivery options'){b['member_email']=b['cp.member_email_tealium_collect']} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if((b['page_name'].toString().toLowerCase()=='checkout>select billing address'.toLowerCase()&&b['ut.env'].toString().toLowerCase()!='prod'.toLowerCase())){
var checkbox = document.getElementById("newsletterAddress");
var formsubmit = document.getElementById("submitButton_IrwAddressDetails");

formsubmit.addEventListener("click", function(){
  document.cookie = "news_letter_signup=" + checkbox.checked
});

} } catch(e){ utag.DB(e) }  }];
  utag.handler.cfg_extend=[{"alr":1,"bwq":0,"id":"115","blr":0,"end":0},{"alr":1,"bwq":0,"id":"73","blr":0,"end":0},{"alr":1,"bwq":0,"id":"74","blr":0,"end":0},{"alr":1,"bwq":0,"id":"75","blr":0,"end":0},{"alr":1,"bwq":0,"id":"169","blr":0,"end":0},{"alr":0,"bwq":0,"id":"178","blr":1,"end":0},{"alr":1,"bwq":0,"id":"79","blr":0,"end":0},{"alr":1,"bwq":0,"id":"76","blr":0,"end":0},{"alr":1,"bwq":0,"id":"98","blr":0,"end":0},{"alr":1,"bwq":0,"id":"118","blr":0,"end":0},{"alr":1,"bwq":0,"id":"120","blr":0,"end":0},{"alr":1,"bwq":0,"id":"124","blr":0,"end":0},{"alr":0,"bwq":0,"id":"126","blr":1,"end":0},{"alr":0,"bwq":0,"id":"127","blr":1,"end":0},{"alr":0,"bwq":0,"id":"128","blr":1,"end":0},{"alr":1,"bwq":0,"id":"130","blr":0,"end":0},{"alr":1,"bwq":0,"id":"145","blr":0,"end":0},{"alr":0,"bwq":0,"id":"150","blr":1,"end":0},{"alr":1,"bwq":0,"id":"155","blr":0,"end":0},{"alr":0,"bwq":0,"id":"168","blr":1,"end":0},{"alr":1,"bwq":0,"id":"176","blr":0,"end":0}];
  utag.loader.initcfg = function(){
    utag.loader.cfg={"3":{load:1,send:1,v:201511090847,wait:1,tid:7115},"8":{load:utag.cond[146],send:1,v:201511090847,wait:1,tid:7117},"32":{load:utag.cond[158],send:1,v:201603231736,wait:1,tid:13032},"40":{load:utag.cond[149],send:1,v:201511090847,wait:1,tid:13032},"1":{load:utag.cond[139],send:1,v:201511090847,wait:1,tid:13032},"4":{load:utag.cond[142],send:1,v:201511090847,wait:1,tid:13032},"5":{load:utag.cond[143],send:1,v:201511090847,wait:1,tid:13032},"31":{load:utag.cond[144],send:1,v:201511090847,wait:1,tid:13032},"6":{load:utag.cond[145],send:1,v:201511090847,wait:1,tid:13032},"7":{load:utag.cond[146],send:1,v:201511090847,wait:1,tid:13032},"10":{load:utag.cond[104],send:1,v:201511090847,wait:1,tid:1068},"19":{load:utag.cond[146],send:1,v:201511090847,wait:1,tid:1068},"20":{load:utag.cond[146],send:1,v:201511090847,wait:1,tid:1068},"24":{load:utag.cond[103],send:1,v:201511090847,wait:1,tid:11006},"29":{load:utag.cond[161],send:1,v:201512160833,wait:1,tid:3108},"25":{load:utag.cond[162],send:1,v:201512160833,wait:1,tid:3108},"33":{load:utag.cond[163],send:1,v:201512160833,wait:1,tid:3108},"28":{load:utag.cond[164],send:1,v:201512160833,wait:1,tid:3108},"34":{load:utag.cond[165],send:1,v:201512160833,wait:1,tid:3108},"26":{load:utag.cond[166],send:1,v:201512160833,wait:1,tid:3108},"45":{load:utag.cond[150],send:1,v:201511090847,wait:1,tid:13032},"58":{load:utag.cond[107],send:1,v:201511090847,wait:1,tid:13032},"59":{load:utag.cond[154],send:1,v:201511090847,wait:1,tid:13032},"86":{load:1,send:1,v:201612081622,wait:1,tid:6026},"87":{load:1,send:1,v:201703211648,wait:1,tid:20010},"117":{load:1,send:1,v:201703211648,wait:0,tid:13084},"125":{load:1,send:1,v:201704261157,wait:1,tid:20064},"134":{load:utag.cond[180],send:1,v:201606270728,wait:1,tid:13032},"135":{load:utag.cond[181],send:1,v:201605251234,wait:1,tid:19063},"159":{load:utag.cond[182],send:1,v:201611101155,wait:1,tid:13032},"160":{load:utag.cond[183],send:1,v:201611101155,wait:1,tid:13032}};
utag.loader.cfgsort=["3","8","32","40","1","4","5","31","6","7","10","19","20","24","29","25","33","28","34","26","45","58","59","86","87","117","125","134","135","159","160"];
  }
utag.loader.initcfg();
}
...
if (utag.data.page_name  == "checkout>select billing address") {
  var x = document.getElementById("signup_checkout_private_email1");
  x.addEventListener("change", myFocusFunction, true);
  function myFocusFunction() {
    document.cookie ="member_email_tealium_collect="+x.value 
  }
};
