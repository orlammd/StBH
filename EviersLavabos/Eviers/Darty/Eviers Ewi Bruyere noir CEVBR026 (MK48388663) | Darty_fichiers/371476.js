...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(371476) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(371476);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=371476";
    else asrc="https://secure.adnxs.com/px?id=371476";
...
if ( tldc.cvPx['371476'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['371476'])) ) tldc.cvPx['371476'].hf = 1;
}
